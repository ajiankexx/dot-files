# Generated from the packages explicitly installed with Homebrew on this Mac.
# Reinstall on another device with: brew bundle --file=~/.config/Brewfile
...
# Go tools managed by Homebrew Bundle.
