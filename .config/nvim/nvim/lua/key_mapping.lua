...
map_set({ 'n', 'x' }, '<leader>ay', function()
    local first_line = 1
    local last_line = vim.api.nvim_buf_line_count(0)
    vim.cmd(string.format('%d,%d yank +', first_line, last_line))
    vim.notify('Buffer copied to system clipboard', vim.log.levels.INFO, { title = 'Copy All' })
